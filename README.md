...
이 프로젝트는 Continuum 프레임워크를 중심으로 공통 레이아웃 로직을 공유하는, 개인 WFH 및 원격 환경용 멀티 키보드 ZMK 워크스페이스입니다.

fork 프로젝트: https://github.com/jbkeg/zmk-config
...
- Prospector scanner 역할 지원(외부 트랙)
...
- 공유 레이어, 콤보, 동작 정의를 재사용해 키보드별 키맵 중복을 줄입니다.
...
- [Eyelash Corne](docs/eyelash_corne.md): 디스플레이, 인코더, 조이스틱을 지원하는 Corne 파생 분할 키보드
...
- Prospector 하드웨어 (`carrefinho/prospector-zmk-module@feat/new-status-screens`의 Operator layout)
...
- [Prospector ZMK Module](https://github.com/carrefinho/prospector-zmk-module/tree/feat/new-status-screens): 활성 Prospector dongle의 Operator 상태 화면 모듈
- [Prospector Scanner Module](https://github.com/t-ogura/prospector-zmk-module): 계획/외부 scanner 트랙
